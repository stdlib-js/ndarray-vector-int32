...
```javascript
import Int32Vector from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-vector-int32@v0.1.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/ndarray-vector-int32/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/ndarray-vector-int32/actions/workflows/test.yml?query=branch:v0.1.1
