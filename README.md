...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/ndarray-vector-int32/tags). For example,

```javascript
Int32Vector = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-vector-int32@v0.1.0-umd/browser.js' )
```
